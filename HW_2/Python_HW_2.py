...
#7. Создать переменную result_multi в которой вы умножаете item_1 на item_2.  8. Вывести result_multi в консоль.
...
result_int = 0.475
print(result_division + result_int)
...
# 33. Создать переменную item_3 и присвоить ей целое число. Вывести item_3 в консоль.
item_3 = 10
print(item_3)
