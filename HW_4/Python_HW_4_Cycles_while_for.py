...
# 2.Создать переменную count со значением 0
count = 0

# 3.Создать переменную range_count со значением 10
range_count = 10

# 4.Создать переменную for_count со значением 0
for_count = 0

# 5.Создать переменную run со значением True
run = True
...
# 	9.2 Сделать if с условием, если “Step =”, count равен range_count то цикл остановится.
...
# Цилы For
# Сделать цикл for c переменной item который будет работать пока счётчик range досчитает
...
# Сделать цикл for c переменной item который будет работать пока счётчик range досчитает от 0 до
 # range_count +1
#     Тело цикла:
