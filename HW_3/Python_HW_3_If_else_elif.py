...
# 31.4 Сделать if в котором будет условие: если currency_result равен ‘eur’, то в теле этого if в
...
if currency_convertor:
    ...
    if currency_result == 'UAH':
        print()
    elif target_currency_amount / usd_uah_rate:
        print('Сумма к обмену в UAH =', target_currency_amount, 'Валюта:', uah_item,
    'Convert: USD/UAH =', target_currency_amount / usd_uah_rate, 'USD')

    if currency_result == 'EUR':
        print()
    elif target_currency_amount / usd_eur_rate:
        print('Сумма к обмену в EUR =', target_currency_amount, 'Валюта:', eur_item,
    'Convert: USD/EUR =', target_currency_amount / usd_eur_rate, 'USD')

    if currency_result == 'CHF':
        print()
    elif target_currency_amount / usd_chf_rate:
        print('Сумма к обмену в CHF =', target_currency_amount, 'Валюта:', chf_item,
    'Convert: USD/CHF =', target_currency_amount / usd_chf_rate, 'USD')

    if currency_result == 'RUB':
        print()
    elif target_currency_amount / usd_rub_rate:
        print('Сумма к обмену в RUB =', target_currency_amount, 'Валюта:', rub_item,
    'Convert: USD/RUB =', target_currency_amount / usd_rub_rate, 'USD')

    if currency_result == 'BYN':
        print()
    elif target_currency_amount / usd_byn_rate:
        print('Сумма к обмену в BYN =', target_currency_amount, 'Валюта:', byn_item,
    'Convert: USD/BYN =', target_currency_amount / usd_byn_rate, 'USD')
    else:
        print()
else:
